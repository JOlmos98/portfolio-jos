        ...
        <div>
            ...
            <div className="bg-gray-300 dark:bg-zinc-800 p-5 lg:p-16 m-6 mt-72 mb-96 rounded-2xl max-w-4xl w-auto mx-auto flex flex-col items-center justify-center">
                <div className="text-center space-y-6">
                    <h1 className="text-3xl lg:text-5xl font-bold text-red-600 dark:text-red-500">
                        {t("Error verifying")}
                    </h1>
                    <p className="text-zinc-700 dark:text-zinc-300">
                        {t("Error during verification")}
                    </p>
                </div>
            </div>
        </div>
...
//                 <h1 className="text-4xl font-bold bg-transparent"></h1>
//                 <div>
//                     <h1 className="text-4xl font-bold bg-transparent text-red-500 text-center mt-52 mb-64">{t("Error during verification")}</h1>
//                 </div>
//             </div>
//         </div>
//     );
