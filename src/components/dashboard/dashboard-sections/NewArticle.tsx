      ...
      <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-6 max-w-[1200px]">
        ...
        <div>
          <textarea
            ...
            className="w-full min-h-[120px] text-blue-cyan dark:text-blue-cyan border border-zinc-300 dark:border-[#121212] bg-neutral-50 dark:bg-neutral-800 px-4 py-2 rounded-2xl"
