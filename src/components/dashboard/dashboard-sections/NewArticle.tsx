      ...
      <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-6">
        <div>
          <input
            type="text"
            placeholder={t("URL")}
            className="w-[315px] lg:w-[600px] text-blue-cyan dark:text-blue-cyan border border-zinc-300 dark:border-[#121212] bg-white dark:bg-[#121212] px-4 py-2 rounded-2xl"
            {...register("url")}
          />
        ...
        <div>
          <textarea
            ...
            className="w-[315px] lg:w-[600px] min-h-[120px] text-blue-cyan dark:text-blue-cyan border border-zinc-300 dark:border-[#121212] bg-white dark:bg-[#121212] px-4 py-2 rounded-2xl"
        ...
        <button
          type="submit"
          className="bg-cyan-600 hover:bg-blue-cyan transition text-white font-bold py-2 px-4 rounded-2xl w-full lg:w-[600px]"
        >
          {t("Submit")}
        </button>
      </form>
