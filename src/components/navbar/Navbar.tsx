...
export const Navbar = () => {
    ...
    return (
        <div className="fixed w-full z-50 transition-all">
            {/* Botón visible si no se ve el navbar */}
            {!isNavbarVisible && (
            ...
            {isNavbarVisible && (
                <nav className="w-full bg-white/50 dark:bg-white/10 backdrop-blur-md shadow-md p-5 flex flex-wrap items-center justify-between transition-transform duration-300">
